...
# Income
DF02<- mutate(DF02, 
             LowIncome02 = ifelse(DF02$INCOME2 == 1 | DF02$INCOME2 ==2 | DF02$INCOME2 == 3, 1, 0),
             MedIncome02 = ifelse(DF02$INCOME2 == 4 | DF02$INCOME3 ==1 | DF02$INCOME3 == 2, 1, 0), 
             HighIncome02 = ifelse(DF02$INCOME3 ==3, 1, 0))
...
## Income
DF06<- mutate(DF06, 
              LowIncome06 = ifelse(DF06$income == 1, 1, 0),
              MedIncome06 = ifelse(DF06$income == 2 | DF06$income == 3 | DF06$income == 4, 1, 0), 
              HighIncome06 = ifelse(DF06$income == 5 | DF06$income == 6, 1, 0))
...
# Education Bin
DF06 <- mutate(DF06,
               LessHSEdu06 = ifelse(DF06$q909 == 1 | DF06$q909  == 2, 1, 0),
               HSGrad06 = ifelse(DF06$q909 == 3 | DF06$q909 == 4, 1, 0),
               CollegeGrad06 = ifelse(DF06$q909  == 5 | DF06$q909  == 6, 1, 0))
...
DF08 <- mutate(DF08, 
               LessHSEdu08 = ifelse(DF08$Q909 == 1 | DF08$Q909 == 2, 1, 0), 
               HSGrad08 = ifelse(DF08$Q909 == 3 | DF08$Q909 == 4, 1, 0),
               CollegeGrad08 = ifelse(DF08$Q909 == 5 | DF08$Q909 == 6, 1, 0))
...
## Income Brackeet 
DF08<- mutate(DF08, 
              LowIncome08 = ifelse(DF08$INCOME == 1, 1, 0),
              MedIncome08 = ifelse(DF08$INCOME == 2 | DF08$INCOME == 3 | DF08$INCOME == 4, 1, 0), 
              HighIncome08 = ifelse(DF08$INCOME == 5 | DF08$INCOME == 6, 1, 0))
...
# income
DF14 <- mutate(DF14, 
               LowIncome14 = ifelse(DF14$income == 1 |
                                        DF14$income == 2 , 1, 0),
               MedIncome14 = ifelse(  DF14$income == 3 |
                                        DF14$income == 4 |
                                        DF14$income == 5 , 1, 0),
               HighIncome14 = ifelse(DF14$income == 6, 1, 0))
###### 2015 #####################################################################################################################################################
library(haven)
library(tidyverse)
...
DF15 <- mutate( DF15, 
                White = ifelse(DF15$Race == 1, 1, 0),
                Black = ifelse(DF15$Race == 2, 1, 0),
                HispWhite = ifelse(DF15$Race == 3, 1, 0),
                Asian = ifelse(DF15$Race == 6, 1, 0),
                OtherRace = ifelse(DF15$Race == 7, 1, 0),
                DkNoOpnRace = ifelse(DF15$Race == 8, 1, 0))
...
# income
DF15 <- mutate(DF15, 
               LowIncome15 = ifelse(DF15$income == 1 |
                                        DF15$income == 2 , 1, 0),
               MedIncome15 = ifelse(  DF15$income == 3 |
                                          DF15$income == 4 |
                                          DF15$income == 5 , 1, 0),
               HighIncome15 = ifelse(DF15$income == 6, 1, 0))
...
BlackresHighIncomeDF00 <- filter(DF00, Black == 1, HighIncome00 == 1)
...
BlackresMedIncomeDF00 <- filter(DF00, Black == 1, MedIncome00 == 1)
...
blackresLowIncomeDF00 <- filter(DF00, Black == 1, LowIncome00 == 1)
...
WhiteresHighIncomeDF00 <- filter(DF00, White == 1, HighIncome00 == 1)
...
WhiteresMedIncomeDF00 <- filter(DF00, White == 1, MedIncome00 == 1)
...
WhiteresLowIncomeDF00 <- filter(DF00, White == 1, LowIncome00 == 1)
...
BlackresHighIncomeDF06 <- filter(DF06, RaceBlack == 1, HighIncome06 == 1)
...
BlackresMedIncomeDF06 <- filter(DF06, RaceBlack == 1, MedIncome06 == 1)
...
blackresLowIncomeDF06 <- filter(DF06, RaceBlack == 1, LowIncome06 == 1)
...
WhiteresHighIncomeDF06 <- filter(DF06, RaceWhite == 1, HighIncome06 == 1)
...
WhiteresMedIncomeDF06 <- filter(DF06, RaceWhite == 1, MedIncome06 == 1)
...
WhiteresLowIncomeDF06 <- filter(DF06, RaceWhite == 1, LowIncome06 == 1)
...
BlackresHighIncomeDF14 <- filter(DF14, Black == 1, HighIncome14 == 1)
...
BlackresMedIncomeDF14 <- filter(DF14, Black == 1, MedIncome14 == 1)
...
blackresLowIncomeDF14 <- filter(DF14, Black == 1, LowIncome14 == 1)
...
WhiteresHighIncomeDF14 <- filter(DF14, White == 1, HighIncome14 == 1)
...
WhiteresMedIncomeDF14 <- filter(DF14, White == 1, MedIncome14 == 1)
...
WhiteresLowIncomeDF14 <- filter(DF14, White == 1, LowIncome14 == 1)
...
BlackresHighIncomeDF15 <- filter(DF15, Black == 1, HighIncome15 == 1)
...
BlackresMedIncomeDF15 <- filter(DF15, Black == 1, MedIncome15 == 1)
...
blackresLowIncomeDF15 <- filter(DF15, Black == 1, LowIncome15 == 1)
...
WhiteresHighIncomeDF15 <- filter(DF15, White == 1, HighIncome15 == 1)
...
WhiteresMedIncomeDF15 <- filter(DF15, White == 1, MedIncome15 == 1)
...
WhiteresLowIncomeDF15 <- filter(DF15, White == 1, LowIncome15 == 1)
...
m2000C <- lm(DevGood4PplYou ~ Black + Female + HighIncome00 + Black*HighIncome00, data = DF00)
stargazer(m2000C)
...
m2002D <-  lm(DevMainlyGood ~ Black + Female + Rent + Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8 + DevInMyNbhd +AGE + INCOME + EDUC, data= DF02)
stargazer(m2002A, m2002B, m2002C, m2002D)


## Dev Good for People Like Me 2006 
m2006A <-  lm(DevGood4PeopleLikeU ~ RaceBlack +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8  + Age + Rent + Female +income +edubreak, data= DF06)
m2006B <-  lm(DevGood4PeopleLikeU ~ RaceBlack +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8  + Age + Rent +Party+ Female +income +edubreak, data= DF06)
stargazer(m2006A, m2006B)

m2006C <-  lm(DevGood4PeopleLikeU ~ RaceBlack +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8  + Age + Rent + Female + HighIncome06 + CollegeGrad06 + RaceBlack*HighIncome06, data= DF06)



## 2008  Development is mainly good for the city Q909= edu
m2008A <- lm(DevGood4City ~ Black +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8  + AGEBREAK + Rent + Female + ForcedMoveLikely + income +Q909, data= DF08)
stargazer(m2008A)

m2008C <- lm(DevGood4City ~ Black +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8  + Age + Rent + Female + ForcedMoveLikely + HighIncome08 + CollegeGrad08 + Black*HighIncome08, data= DF08)
stargazer(m2008C)
...
m2014A <- lm(ProGen ~ Black +  Ward2 + Ward3 + Ward4+ Ward5 + Ward6 + Ward7 + Ward8 + YrsinDC6to19+ YrsinDC20to39 + YrsinDC40Plus + YrsinDCWholeLife + HighIncome14, data= DF14)
stargazer(m2014A)
...
m2015A <- lm(ReDevGood ~ black + wardnew + Age + Female + IncomeUnder20k+ Income20kto35k + Income35kto50k + Income50kto65k+Income65kto100k+ InDCLessThan5Yrs+InDC6to19Yrs+InDC20to39Yrs, data= DF15)
stargazer(m2015A)

# New interractions
RegInteractions <- stargazer(m2000C, m2006C, m2008C )
